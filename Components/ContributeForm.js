...
const Contribution = (address) => {
    ...
    return (
        <Form  onSubmit={(e) => {submitting(e)}} error={!!errMsg}>
            <Form.Field>
                <label>Amount to Contribute</label>
                <Input value={value} onChange={(e) => {setVal(e.target.value)}} type="number" label="in ethers" labelPosition="right"/>
            </Form.Field>
            <Button type="submit" loading={load} primary>Contribute</Button>
